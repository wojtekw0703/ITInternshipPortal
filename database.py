from indeed_scraping import list_of_id,list_of_company,list_of_locations, list_of_titles, list_of_urls
from wayup_scraping import list_of_job_titles,href_list
...
for i in range(0,len(list_of_id)):
    insertVariblesIntoTable(list_of_id[i],list_of_titles[i],list_of_company[i],list_of_locations[i],list_of_urls[i])
for i in range(0,len(list_of_job_titles)):
    insertVariblesIntoTable(i, list_of_job_titles[i], "None","-", href_list[i])
